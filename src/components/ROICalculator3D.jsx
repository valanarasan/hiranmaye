...
export default function ROICalculator3D({ onOpenConsultation }) {
  return (
    <Tilt3DCard className="w-full max-w-2xl mx-auto">
      <div className="glass-dark rounded-3xl p-8 sm:p-12 text-center space-y-6 relative overflow-hidden border-zinc-200">
        ...
        <div className="relative z-10 space-y-4">
          <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-orange-500 flex items-center justify-center mx-auto shadow-2xl shadow-orange-500/20 animate-neon-pulse">
            <span className="text-4xl sm:text-5xl font-black text-white">4X</span>
          </div>

          <h3 className="text-2xl sm:text-3xl font-bold text-zinc-900">Average ROI</h3>
